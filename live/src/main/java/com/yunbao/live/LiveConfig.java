...
public class LiveConfig {
    //推流参数配置
//    public static final int PUSH_CAP_RESOLUTION = StreamerConstants.VIDEO_RESOLUTION_480P;//采集分辨率
//    public static final int PUSH_PREVIEW_RESOLUTION = StreamerConstants.VIDEO_RESOLUTION_480P;//直播预览分辨率
//    public static final int LINK_MIC_PUSH_PREVIEW_RESOLUTION = StreamerConstants.VIDEO_RESOLUTION_480P;//连麦预览分辨率
...
//    public static final int PUSH_ENCODE_PROFILE = VideoEncodeFormat.ENCODE_PROFILE_LOW_POWER;//低功耗
    ...
    public static final int PUSH_VIDEO_BITRATE_MAX = 1500;//视频码率
