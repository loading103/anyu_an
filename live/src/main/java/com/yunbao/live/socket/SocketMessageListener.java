...
public interface SocketMessageListener {
     ...
     * 私密直播消息
     */
    void onSendPrivateLive(int type,String user);

    /**
     * 切换推拉流
     * @param cnd_switch
     */
    void onSendSwitchLive(int cnd_switch);
    /**
     * 推送用户列表
     * @param
     */
    void onSendUserList(String user,String nums);
    /**
     * 直播间  观众收到直播结束消息
     * @param ct
     */
    void onLiveEnd(String ct);

    /**
     * 直播间  超管关闭直播间
     * @param s
     */
    void onSuperCloseLive(String s);
     ...
     */
    void onChangeTimeCharge(int type,int typeVal);
...
/***********************以下是游戏*********************************/
    ...
    void onReceiveSendMsgFail(SocketMessageBean bean, String retmsg);

    void onReceiveSendMsgSuccess(SocketMessageBean bean);

    void onReceivePrivateLetterMsg(SocketMessageBean bean);
}
