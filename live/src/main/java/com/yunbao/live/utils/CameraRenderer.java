...
import com.faceunity.nama.utils.LimitFpsUtil;
import com.yunbao.live.utils.gles.ProgramTexture2d;
import com.yunbao.live.utils.gles.ProgramTextureOES;
...
public class CameraRenderer extends IZegoCustomVideoCaptureHandler implements GLSurfaceView.Renderer, Camera.PreviewCallback {
    ...
    private boolean mIsStarted; //避免SDK重复调用
