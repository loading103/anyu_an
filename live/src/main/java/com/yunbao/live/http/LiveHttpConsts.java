...
public class LiveHttpConsts {
    ...
    public static final String LIVE_GETGOODS = "getGoods";
    public static final String GET_LOCATION = "getLocation";
    public static final String GET_BALANCE = "getLalance";
    public static final String GET_UPLOAD_URL_INFO = "getUploadUrlInfo";
    public static final String GET_VIDEO_COMMENT_LIST = "getComments";
    public static final String DO_REDIRECT = "doRedirect";
    public static final String DO_MACHINEBUY = "doMachineBuy";
    public static final String DO_APPLY_PRI = "applyPri";
    public static final String GET_LIVE_HANDLE = "liveHandle";
    public static final String DO_CLOSE_PRIVATE = "closePrivate";
    public static final String DO_START_PRIVATE = "startPrivate";
    public static final String CHECK_LIVEING = "checkLiveing";
    public static final String RESET_LIVE_URL = "resetLiveUrl";
