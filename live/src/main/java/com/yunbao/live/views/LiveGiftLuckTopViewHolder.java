...
public class LiveGiftLuckTopViewHolder extends AbsViewHolder {
    ...
    public LiveGiftLuckTopViewHolder(Context context, ViewGroup parentView, int parentWidth) {
        super(context, parentView, parentWidth);
    }

    @Override
    protected void processArguments(Object... args) {
        mParentWidth = (int) args[0];
    }
    ...
    public void show(LiveLuckGiftWinBean bean) {
        ...
        mAimating = true;
        mGiftTip.setText(String.format(mTipString, bean.getUserNiceName(), bean.getLuckTime()));
        mGiftTip.measure(0,0);
        mTextAnimtor.setFloatValues(mParentWidth, -mGiftTip.getMeasuredWidth());
