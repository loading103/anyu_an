...
//                    mStreamer.getImgTexFilterMgt().setFilter(new TiFilter(TiSDKManager.getInstance(), mStreamer.getGLRender()));
//                }
//                mStreamer.setDisplayPreview((GLSurfaceView) mPreView);
//                mStreamer.startCameraPreview();//启动预览
//            }
//        }catch (Exception e){
//            L.e("WOLF","mStreamer初始化异常");
//        }
