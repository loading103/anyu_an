...
public class LivePlayKsyViewHolder extends LiveRoomPlayViewHolder implements
        IMediaPlayer.OnPreparedListener, IMediaPlayer.OnErrorListener, IMediaPlayer.OnInfoListener,IMediaPlayer.OnBufferingUpdateListener {
    ...
    public void setCover(String coverUrl) {
        if (mCover != null) {
            ImgLoader.displayBlur(CommonAppContext.sInstance,coverUrl, mCover);
        }
    }
