 ...
 */
public abstract class GSYBaseActivityDetail<T extends GSYBaseVideoPlayer> extends AbsVideoPlayActivity implements VideoAllCallBack {
    ...
    public void initVideoBuilderMode() {
        initVideo();
        if(getGSYVideoOptionBuilder()==null){
            return;
        }
    ...
    protected void onPause() {
        super.onPause();
        if(getGSYVideoPlayer()!=null&&getGSYVideoPlayer().getCurrentPlayer()!=null){
