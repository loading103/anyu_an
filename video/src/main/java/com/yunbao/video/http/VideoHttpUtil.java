...
public class VideoHttpUtil {
     ...
     * 获取首页视频列表
     */
    public static void getHomeVideoList(String classid,String is_rand,int p, HttpCallback callback) {
        HttpClient.getInstance().get("Video.GetVideoList", VideoHttpConsts.GET_HOME_VIDEO_LIST)
                .params("uid", CommonAppConfig.getInstance().getUid())
                .params("token", CommonAppConfig.getInstance().getToken())
                .params("p", p)
                .params("classid", classid)
                .params("is_rand", is_rand)//是否随机
                .cacheKey(p>1?"":classid)
     ...
     * 获取视频猜你喜欢
     */
    public static void getGuessLike(HttpCallback callback) {
        HttpClient.getInstance().get("Video.guess_like", VideoHttpConsts.GET_GUESS_LIKE)
                .params("uid", CommonAppConfig.getInstance().getUid())
                .execute(callback);
    }
     ...
     */
    public static void saveUploadVideoInfo(String title, String thumb, String href, int musicId,String classid, HttpCallback callback) {
    ...
    public static void getUploadUrlInfo(HttpCallback callback) {
        String uid = CommonAppConfig.getInstance().getUid();
        HttpClient.getInstance().get("Upload.GetUploadUrlInfo", VideoHttpConsts.GET_UPLOAD_URL_INFO)
                .params("uid", uid)
                .params("token", CommonAppConfig.getInstance().getToken())
                .execute(callback);
    }
    ...
    public static void getLiveRecommend(int p, HttpCallback callback) {
        HttpClient.getInstance().get("Live.Recommend", VideoHttpConsts.GET_LIVE_RECOMMEND)
                .params("p", p)
                .params("uid", CommonAppConfig.getInstance().getUid())
                .execute(callback);
    }
