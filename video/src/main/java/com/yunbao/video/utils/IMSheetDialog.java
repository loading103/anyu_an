...
public class IMSheetDialog extends Dialog {

    public IMSheetDialog(Context context, int themeResId) {
    ...
    public static class Builder {
        ...
        public IMSheetDialog create() {
            final IMSheetDialog dialog = new IMSheetDialog(p.context, shadow ? R.style.Theme_Light_NoTitle_Dialog : R.style.Theme_Light_NoTitle_NoShadow_Dialog);
            ...
            View view = LayoutInflater.from(p.context).inflate(R.layout.layout_sheet_dialog, null);
            ...
            if (hasTitle) {
                ...
                tTitle.setTextColor(p.context.getResources().getColor(R.color.color_333333));
            ...
            for (int i = 0; i < p.menuList.size(); i++) {
                ...
                bbm.setTextColor(p.context.getResources().getColor(R.color.color_333333));
                bbm.setTextSize(16);
                final int finalI = i;
