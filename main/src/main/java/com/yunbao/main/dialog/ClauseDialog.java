 ...
 * 条款弹框
 */
public class ClauseDialog implements View.OnClickListener {
    ...
    public ClauseDialog(Context context, String content) {
        this.context=context;
        this.content=content;
    }
    public void showNoticeDiglog() {
        builder = new AlertDialog.Builder(context);
        View dialogView =  View.inflate(context, R.layout.dialog_clause, null);
