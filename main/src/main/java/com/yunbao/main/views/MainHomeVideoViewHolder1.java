...
public class MainHomeVideoViewHolder1 extends AbsMainHomeChildViewHolder implements OnItemClickListener<VideoBean> {
    ...
    public MainHomeVideoViewHolder1(Context context, ViewGroup parentView) {
    ...
    public void init() {
        ...
        mAdapter.setOnItemClickListener(MainHomeVideoViewHolder1.this);
