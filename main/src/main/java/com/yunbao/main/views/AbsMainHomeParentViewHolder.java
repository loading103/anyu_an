...
public abstract class AbsMainHomeParentViewHolder extends AbsMainViewHolder {
    ...
    public AbsMainHomeParentViewHolder(Context context, ViewGroup parentView, List<LiveClassBean> list) {
    ...
    public void showTitle() {
        ...
        commonNavigator.setAdapter(new CommonNavigatorAdapter() {
            ...
            public IPagerTitleView getTitleView(Context context, final int index) {
                ...
                simplePagerTitleView.setSelectedColor(ContextCompat.getColor(mContext, R.color.color_8B2AFB));
            ...
            public IPagerIndicator getIndicator(Context context) {
                ...
                linePagerIndicator.setColors(ContextCompat.getColor(mContext, R.color.color_8B2AFB));
