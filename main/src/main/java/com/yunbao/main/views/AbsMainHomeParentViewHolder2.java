...
import com.yunbao.common.utils.NoScrollViewPager;
...
public abstract class AbsMainHomeParentViewHolder2 extends AbsMainViewHolder {
    ...
    public AbsMainHomeParentViewHolder2(Context context, ViewGroup parentView) {
        super(context, parentView);
    }
    public AbsMainHomeParentViewHolder2(Context context, ViewGroup parentView, List<LiveClassBean> list) {
    ...
    public void showTitle() {
        ...
        mViewPager.addOnPageChangeListener(new ViewPager.OnPageChangeListener() {
            ...
            public void onPageSelected(int position) {
                Log.e("onPageSelected111----:","position="+position);
...
//                SimplePagerTitleView1 simplePagerTitleView = new ColorTransitionPagerTitleView1(context);
                ...
                simplePagerTitleView.setNormalColor(ContextCompat.getColor(mContext, R.color.color_9A9A9A));
