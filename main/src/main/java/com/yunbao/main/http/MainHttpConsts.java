...
public class MainHttpConsts {
    ...
    public static final String GET_TU_CODE = "getTuCode";
    ...
    public static final String GET_LIVE_RECOMMEND = "getLiveRecommend";
    public static final String GET_SHOP_LIST = "GetHallClass";
    public static final String GET_SHOP_DETAIL = "GetApp";
    public static final String GET_SHOP_TABBAR = "Tabbar";
    public static final String GET_CHECK_PHONE = "GetVerifyCode";
}
