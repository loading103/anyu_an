...
public class CaptureLayout extends FrameLayout {
    ...
    private ClickListener chooseClickListener;   //右边按钮监听
    ...
    private ImageView iv_right_choose;            //右边选择视屏
    ...
    public void initEvent() {
        //默认Typebutton为隐藏
        iv_right_choose.setVisibility(VISIBLE);
    ...
    public void startTypeBtnAnimator() {
        ...
        iv_right_choose.setVisibility(GONE);
...
//                resetCaptureLayout();
        ...
        iv_right_choose = new ImageView(getContext());
        LayoutParams iv_param_right = new LayoutParams((int) (button_size / 2.5f), (int) (button_size / 2.5f));
        iv_param_right.gravity = Gravity.CENTER_VERTICAL | Gravity.RIGHT;
        iv_param_right.setMargins(0, 0, layout_width / 6, 0);
        iv_right_choose.setLayoutParams(iv_param_right);
        iv_right_choose.setBackgroundResource(R.mipmap.sao_pic);
        iv_right_choose.setOnClickListener(new OnClickListener() {
            @Override
            public void onClick(View v) {
                if (chooseClickListener != null) {
                    chooseClickListener.onClick();
                }
            }
        });
    ...
    public void setChooseClickListener(ClickListener chooseClickListener) {
