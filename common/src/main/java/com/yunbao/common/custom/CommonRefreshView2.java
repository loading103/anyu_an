...
public class CommonRefreshView2 extends FrameLayout implements View.OnClickListener {
    ...
    public CommonRefreshView2(Context context) {
        this(context, null);
    }

    public CommonRefreshView2(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public CommonRefreshView2(Context context, AttributeSet attrs, int defStyleAttr) {
