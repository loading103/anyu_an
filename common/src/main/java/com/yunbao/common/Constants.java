...
public class Constants {
    ...
    public static final int LIVE_FUNC_TYPE = 2009;//房间类型
    //socket
    ...
    public static final String SOCKET_PRIVATE_LIVE = "PrivateLive";//私密直播
    ...
    public static final String SOCKET_CHANGE_LIVE = "changeLive2";//切换计时收费类型
    ...
    public static final String SOCKET_SWITCH_LIVE = "SwitchLive";//切换推拉流
    public static final String SOCKET_USER_LIST = "userList";//推用户
    public static final String SOCKET_PEIVATE_LATE = "privateLetter";//私信
    ...
    public static final String MORE_WEB_URL = "more_web_url";//直播界面更多Web
    public static final String USER_VIP = "user_vip";//用户vip
    public static final String HTML_TOKEN = "html_token";//路由token
