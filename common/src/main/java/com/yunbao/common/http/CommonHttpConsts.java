...
public class CommonHttpConsts {
    ...
    public static final String GET_UID_TOKEN = "GetUidToken";
    public static final String GET_USER_VIP = "getUserVip";
    public static final String GET_USER_SHOT = "getforBitShot";
}
