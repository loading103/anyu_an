...
/**
 * @author：jianxin 创建时间：2020/10/13
 */
public class ScreenShotListenManager {
    ...
    public void startListen() {
        ...
        if(Build.VERSION.SDK_INT >= Build.VERSION_CODES.Q){
            mContext.getContentResolver().registerContentObserver(MediaStore.Images.Media.INTERNAL_CONTENT_URI, true, mInternalObserver);
            mContext.getContentResolver().registerContentObserver(MediaStore.Images.Media.EXTERNAL_CONTENT_URI, true, mExternalObserver);
        }else {
