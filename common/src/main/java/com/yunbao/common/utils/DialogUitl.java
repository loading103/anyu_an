...
public class DialogUitl {
    ...
    /**
     * 用于网络请求等耗时操作的LoadingDialog2(不可取消)
     */
    public static Dialog loadingNewDialog(Context context) {
        Dialog dialog = new Dialog(context, R.style.dialog);
        dialog.setContentView(R.layout.dialog_loading_new);
        dialog.setCancelable(false);
        dialog.setCanceledOnTouchOutside(false);
        return dialog;
    }
    ...
    /**
     * 用于网络请求等耗时操作的LoadingDialog2(不可取消)(白色背景)
     */
    public static Dialog loadingNewWhiteDialog(Context context) {
     ...
     * (可以取消)(白色背景)
     */
    public static Dialog loadingNew2WhiteDialog(Context context) {
        Dialog dialog = new Dialog(context, R.style.dialog2);
        dialog.setContentView(R.layout.dialog_loading_new);
     ...
     * 可以取消
     */
    public static Dialog loadingNew2Dialog(Context context) {
        Dialog dialog = new Dialog(context, R.style.dialog);
        dialog.setContentView(R.layout.dialog_loading_new);
        dialog.setCancelable(true);
        dialog.setCanceledOnTouchOutside(true);
     ...
     * 可以取消
     */
    public static Dialog loadingNew3Dialog(Context context) {
        Dialog dialog = new Dialog(context, R.style.dialog);
        dialog.setContentView(R.layout.dialog_loading_new2);
        dialog.setCancelable(true);
        dialog.setCanceledOnTouchOutside(true);
        return dialog;
    }
    ...
    public static void showSimpleTipCallDialog(Context context, String title, String content, final SimpleCallback callback) {
        if(context==null){
            return;
        }
        final Dialog dialog = new Dialog(context, R.style.dialog2);
        ...
        dialog.findViewById(R.id.btn_confirm).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (callback != null) {
                    callback.onConfirmClick(null,null);
                }
                dialog.dismiss();
            }
        });
    ...
    public static void showStringArrayDialog1(Context context, Integer[] array,  final StringArrayDialogCallback callback, final View.OnClickListener onClickListener) {
        final Dialog dialog = new Dialog(context, R.style.dialog);
        dialog.setContentView(R.layout.dialog_string_array);
        dialog.setCancelable(true);
        dialog.setCanceledOnTouchOutside(false);
