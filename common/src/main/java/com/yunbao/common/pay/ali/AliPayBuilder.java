package com.yunbao.common.pay.ali;
...
public class AliPayBuilder {
    ...
    public void pay() {
        ...
        CommonHttpUtil.getAliOrder(mBean.getMoney(), mBean.getId(), mBean.getCoin(), new HttpCallback() {
            @Override
    ...
    private String createAliOrder(String orderId) {
        ...
        orderInfo += "&notify_url=" + "\"" + config.getALI_PAY_NOTIFY_URL() + "\"";
