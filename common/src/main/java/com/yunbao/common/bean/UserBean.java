...
public class UserBean implements Parcelable {
    ...
    public String getTeliao() {
        return teliao;
    }

    public void setTeliao(String teliao) {
        this.teliao = teliao;
    }
    ...
    public void setAuth_islimit(String auth_islimit) {
        this.auth_islimit = auth_islimit;
    }
    ...
    public String getZhangHao() {
        String names= SpUtil.getInstance().getStringValue(SpUtil.ZHANG_HAO);
        return "账号:" +(TextUtils.isEmpty(names)? "":names);
    }
    ...
    protected UserBean(Parcel in) {
        ...
        this.auth_islimit = in.readString();
        ...
        this.king = in.readParcelable(King.class.getClassLoader());
        this.wechat = in.readString();
        this.qq = in.readString();
        this.teliao = in.readString();
    ...
    public static class Vip implements Parcelable {
        protected int type;
        protected int vip_is_king;

        public int getVip_is_king() {
            return vip_is_king;
        }

        public void setVip_is_king(int vip_is_king) {
        ...
        public Vip(Parcel in) {
            ...
            this.vip_is_king = in.readInt();
        }

        @Override
        public void writeToParcel(Parcel dest, int flags) {
            dest.writeInt(this.type);
            dest.writeInt(this.vip_is_king);
        }
    ...
    public static class King implements Parcelable{
        private String balance;
        private String king_res;
        ...
        public String getKing_res() {
            return king_res;
        }

        public void setKing_res(String king_res) {
            this.king_res = king_res;
        }
        ...
        public void writeToParcel(Parcel dest, int flags) {
            ...
            dest.writeString(this.king_res);
        }

        public King(String balance,String king_res) {
            this.balance = balance;
            this.king_res = king_res;
        }
        ...
        public static final Creator<King> CREATOR = new Creator<King>() {
            ...
            public King createFromParcel(Parcel in) {
                return new King(in.readString(),in.readString());
            }
